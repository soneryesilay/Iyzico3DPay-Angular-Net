...
namespace Server.Controllers
{
	...
	public class PaymentsController : ControllerBase
	{
		...
		public PaymentsController(IHubContext<PaymentHub> hubContext)
		{
		...
		public async Task<IActionResult> Pay()
		{
			Options options = new()
			{
				ApiKey = "sandbox-qXPmA4He0fFRkCelESrBZYB76j2GMVEo",
				SecretKey = "sandbox-985gr5gCPRwRUv25Taj4N4A3nWftrSY0",
			...
			request.CallbackUrl = "https://localhost:7032/api/Payments/PayCallBack";
		...
		public async Task<IActionResult> PayCallBack([FromForm] IFormCollection collections)
		{
			...
			await _hubContext.Clients.Client(PaymentHub.TransactionConnections[data.ConversationId]).SendAsync("Receive", data);
